...
void main ()
{
  ...
  if (_UseClipRect) {
    ...
    highp vec2 position_8;
    position_8 = xlv_TEXCOORD2.xy;
    highp vec2 tmpvar_9;
    tmpvar_9.x = float((_ClipRect.z >= position_8.x));
    tmpvar_9.y = float((_ClipRect.w >= position_8.y));
    highp vec2 tmpvar_10;
    tmpvar_10 = (vec2(greaterThanEqual (position_8, _ClipRect.xy)) * tmpvar_9);
    tmpvar_7 = (tmpvar_10.x * tmpvar_10.y);
    c_2 = (c_2 * tmpvar_7);
  };
  tmpvar_1 = c_2;
  gl_FragData[0] = tmpvar_1;
...
void main()
{
    ...
    u_xlat16_2.xy = vec2(u_xlat10_3) * vs_TEXCOORD1.xx + (-vs_TEXCOORD1.zy);
#ifdef UNITY_ADRENO_ES3
    u_xlat16_2.xy = min(max(u_xlat16_2.xy, 0.0), 1.0);
#else
    u_xlat16_2.xy = clamp(u_xlat16_2.xy, 0.0, 1.0);
#endif
    u_xlat16_1 = u_xlat16_2.xxxx * u_xlat16_1 + vs_COLOR1;
    u_xlat16_1 = u_xlat16_2.yyyy * u_xlat16_1;
    u_xlat0 = u_xlat0.xxxx * u_xlat16_1;
    u_xlat16_0 = (_UseClipRect != 0) ? u_xlat0 : u_xlat16_1;
    SV_Target0 = u_xlat16_0;
    return;
