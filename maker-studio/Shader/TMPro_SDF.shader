...
void main()
{
    ...
    vs_TEXCOORD1.z = u_xlat6 * 0.00122070312;
    u_xlat6 = fract(in_TEXCOORD1.x);
    vs_TEXCOORD1.w = u_xlat6 * 5.0;
    ...
    vs_TEXCOORD3.zw = vec2(0.5, 0.5) / u_xlat1.xy;
...
void main()
{
    u_xlat10_0.x = texture(_MainTex, vs_TEXCOORD1.xy).w;
    u_xlat6 = u_xlat10_0.x + (-vs_TEXCOORD2.x);
    u_xlat0.x = (-u_xlat10_0.x) + vs_TEXCOORD2.z;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_13 = u_xlat0.x * vs_TEXCOORD2.y + u_xlat16_7;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_13 = min(max(u_xlat16_13, 0.0), 1.0);
#else
    u_xlat16_13 = clamp(u_xlat16_13, 0.0, 1.0);
#endif
    u_xlat16_7 = u_xlat0.x * vs_TEXCOORD2.y + (-u_xlat16_7);
    ...
    u_xlat16_2 = u_xlat10_0 * vs_COLOR1;
    u_xlat0.xy = vec2(_FaceUVSpeedX, _FaceUVSpeedY) * _Time.yy + vs_TEXCOORD1.zw;
    u_xlat10_3 = texture(_FaceTex, u_xlat0.xy);
    u_xlat16_4 = u_xlat10_3 * vs_COLOR0;
    u_xlat10_5.xyz = u_xlat16_4.www * u_xlat16_4.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat16_2.www + (-u_xlat10_5.xyz);
    u_xlat16_2.w = vs_COLOR1.w * u_xlat10_0.w + (-u_xlat16_4.w);
    u_xlat16_0 = vec4(u_xlat16_1) * u_xlat16_2;
    u_xlat16_2.xyz = u_xlat16_4.xyz * u_xlat16_4.www + u_xlat16_0.xyz;
    u_xlat16_2.w = vs_COLOR0.w * u_xlat10_3.w + u_xlat16_0.w;
    u_xlat3.x = _OutlineSoftness * _ScaleRatioA;
    u_xlat9 = u_xlat3.x * vs_TEXCOORD2.y;
    u_xlat16_1 = u_xlat3.x * vs_TEXCOORD2.y + 1.0;
...
void main ()
{
  ...
  tmpvar_23 = (tmpvar_7 - ((_GlowOffset * _ScaleRatioB) * (0.5 * xlv_TEXCOORD2.y)));
  highp float tmpvar_24;
  tmpvar_24 = ((mix (_GlowInner, 
    (_GlowOuter * _ScaleRatioB)
  , 
    float((tmpvar_23 >= 0.0))
  ) * 0.5) * xlv_TEXCOORD2.y);
  glow_22 = (1.0 - pow (clamp (
    abs((tmpvar_23 / (1.0 + tmpvar_24)))
  , 0.0, 1.0), _GlowPower));
  glow_22 = (glow_22 * sqrt(min (1.0, tmpvar_24)));
  highp float tmpvar_25;
  tmpvar_25 = clamp (((_GlowColor.w * glow_22) * 2.0), 0.0, 1.0);
  lowp vec4 tmpvar_26;
  tmpvar_26.xyz = _GlowColor.xyz;
  tmpvar_26.w = tmpvar_25;
  tmpvar_21 = tmpvar_26;
  faceColor_3.xyz = (faceColor_3.xyz + ((tmpvar_21.xyz * tmpvar_21.w) * xlv_TEXCOORD0));
  if (_UseClipRect) {
    highp float tmpvar_27;
    highp vec2 tmpvar_28;
    tmpvar_28.x = float((_ClipRect.z >= xlv_TEXCOORD3.x));
    tmpvar_28.y = float((_ClipRect.w >= xlv_TEXCOORD3.y));
    highp vec2 tmpvar_29;
    tmpvar_29 = (vec2(greaterThanEqual (xlv_TEXCOORD3.xy, _ClipRect.xy)) * tmpvar_28);
    tmpvar_27 = (tmpvar_29.x * tmpvar_29.y);
    faceColor_3 = (faceColor_3 * tmpvar_27);
  };
  tmpvar_1 = faceColor_3;
  gl_FragData[0] = tmpvar_1;
}
...
void main()
{
    ...
    u_xlat1.x = (-_OutlineWidth) * _ScaleRatioA + 1.0;
    u_xlat1.x = (-_OutlineSoftness) * _ScaleRatioA + u_xlat1.x;
    u_xlat4.x = (-_GlowOffset) * _ScaleRatioB + 1.0;
    u_xlat4.x = (-_GlowOuter) * _ScaleRatioB + u_xlat4.x;
...
void main()
{
    ...
    u_xlat7.x = u_xlat10_0 + (-vs_TEXCOORD2.x);
    u_xlat0.x = (-u_xlat10_0) + vs_TEXCOORD2.z;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat7.x = u_xlat7.x * vs_TEXCOORD2.y;
    u_xlat16_1.x = min(u_xlat7.x, 1.0);
    u_xlat16_8 = u_xlat7.x * 0.5;
    u_xlat16_1.x = sqrt(u_xlat16_1.x);
    u_xlat16_15 = u_xlat0.x * vs_TEXCOORD2.y + u_xlat16_8;
#ifdef UNITY_ADRENO_ES3
    u_xlat16_15 = min(max(u_xlat16_15, 0.0), 1.0);
#else
    u_xlat16_15 = clamp(u_xlat16_15, 0.0, 1.0);
#endif
    u_xlat16_8 = u_xlat0.x * vs_TEXCOORD2.y + (-u_xlat16_8);
    u_xlat16_1.x = u_xlat16_1.x * u_xlat16_15;
    u_xlat7.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD1.zw;
    u_xlat10_2 = texture(_OutlineTex, u_xlat7.xy);
    u_xlat16_3 = u_xlat10_2 * vs_COLOR1;
    u_xlat7.xy = vec2(_FaceUVSpeedX, _FaceUVSpeedY) * _Time.yy + vs_TEXCOORD1.zw;
    u_xlat10_4 = texture(_FaceTex, u_xlat7.xy);
    u_xlat16_5 = u_xlat10_4 * vs_COLOR0;
    u_xlat10_6.xyz = u_xlat16_5.www * u_xlat16_5.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_3.www + (-u_xlat10_6.xyz);
    u_xlat16_3.w = vs_COLOR1.w * u_xlat10_2.w + (-u_xlat16_5.w);
    u_xlat16_2 = u_xlat16_1.xxxx * u_xlat16_3;
    u_xlat16_3.xyz = u_xlat16_5.xyz * u_xlat16_5.www + u_xlat16_2.xyz;
    u_xlat16_3.w = vs_COLOR0.w * u_xlat10_4.w + u_xlat16_2.w;
    u_xlat0.y = _OutlineSoftness * _ScaleRatioA;
    u_xlat0.xz = u_xlat0.xy * vs_TEXCOORD2.yy;
    u_xlat16_1.x = u_xlat0.y * vs_TEXCOORD2.y + 1.0;
    ...
    u_xlat0.xyz = u_xlat0.xyz * vec3(vs_TEXCOORD0) + u_xlat16_1.xyz;
    u_xlatb4.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _ClipRect.xyxx).xy;
    u_xlatb4.zw = greaterThanEqual(_ClipRect.zzzw, vs_TEXCOORD3.xxxy).zw;
    u_xlat4 = mix(vec4(0.0, 0.0, 0.0, 0.0), vec4(1.0, 1.0, 1.0, 1.0), vec4(u_xlatb4));
    u_xlat4.xy = vec2(u_xlat4.z * u_xlat4.x, u_xlat4.w * u_xlat4.y);
    u_xlat21 = u_xlat4.y * u_xlat4.x;
    u_xlat4.xyz = vec3(u_xlat21) * u_xlat0.xyz;
    u_xlat16_2.xyz = (_UseClipRect != 0) ? u_xlat4.xyz : u_xlat0.xyz;
    u_xlat0.x = u_xlat21 * u_xlat16_1.w;
    u_xlat16_2.w = (_UseClipRect != 0) ? u_xlat0.x : u_xlat16_1.w;
