...
void main ()
{
  ...
  resultColor_1 = (texture2D (_MainTex, P_2) * 0.05);
  highp vec2 P_4;
  highp vec2 tmpvar_5;
  tmpvar_5 = (xlv_TEXCOORD1 * 3.0);
  P_4 = (xlv_TEXCOORD0 - tmpvar_5);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_4) * 0.09));
  highp vec2 P_6;
  highp vec2 tmpvar_7;
  tmpvar_7 = (xlv_TEXCOORD1 * 2.0);
  P_6 = (xlv_TEXCOORD0 - tmpvar_7);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_6) * 0.12));
  highp vec2 P_8;
  P_8 = (xlv_TEXCOORD0 - xlv_TEXCOORD1);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_8) * 0.15));
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, xlv_TEXCOORD0) * 0.18));
  highp vec2 P_9;
  P_9 = (xlv_TEXCOORD0 + xlv_TEXCOORD1);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_9) * 0.15));
  highp vec2 P_10;
  P_10 = (xlv_TEXCOORD0 + tmpvar_7);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_10) * 0.12));
  highp vec2 P_11;
  P_11 = (xlv_TEXCOORD0 + tmpvar_5);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_11) * 0.09));
  highp vec2 P_12;
  P_12 = (xlv_TEXCOORD0 + tmpvar_3);
  resultColor_1 = (resultColor_1 + (texture2D (_MainTex, P_12) * 0.05));
...
void main()
{
    ...
    u_xlat1.xy = vec2((-vs_TEXCOORD1.x) + vs_TEXCOORD0.x, (-vs_TEXCOORD1.y) + vs_TEXCOORD0.y);
    u_xlat10_1 = texture(_MainTex, u_xlat1.xy);
