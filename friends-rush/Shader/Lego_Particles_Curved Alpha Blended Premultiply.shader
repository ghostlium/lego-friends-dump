...
//
///////////////////////////////////////////
Shader "Lego/Particles/Curved Alpha Blended Premultiply" {
Properties {
...
void main()
{
    ...
    u_xlat2 = (-u_xlat3.x) * 0.0549999997 + u_xlat0.y;
    u_xlat3.xyz = vec3(u_xlat2) * hlslcc_mtx4x4unity_WorldToObject[1].xyz;
    u_xlat2 = u_xlat1.x * 0.00999999978;
    vs_TEXCOORD1.z = (-u_xlat1.x);
    u_xlat2 = u_xlat2 * u_xlat2;
    u_xlat0.x = _offset * u_xlat2 + u_xlat0.x;
    u_xlat1.xyz = hlslcc_mtx4x4unity_WorldToObject[0].xyz * u_xlat0.xxx + u_xlat3.xyz;
    u_xlat0.xyz = hlslcc_mtx4x4unity_WorldToObject[2].xyz * u_xlat0.zzz + u_xlat1.xyz;
    u_xlat0.xyz = hlslcc_mtx4x4unity_WorldToObject[3].xyz * u_xlat0.www + u_xlat0.xyz;
    u_xlat1 = u_xlat0.yyyy * hlslcc_mtx4x4unity_ObjectToWorld[1];
    u_xlat1 = hlslcc_mtx4x4unity_ObjectToWorld[0] * u_xlat0.xxxx + u_xlat1;
