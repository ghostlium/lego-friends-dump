...
//
///////////////////////////////////////////
Shader "Lego/Effects/Trail_AdditiveDissolve" {
Properties {
...
uniform lowp sampler2D _Dissolve;
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xy * _Dissolve_ST.xy + _Dissolve_ST.zw;
    u_xlat10_0.x = texture2D(_Dissolve, u_xlat0.xy).x;
    u_xlat0.x = vs_COLOR0.w * 0.720000029 + u_xlat10_0.x;
    u_xlat0.x = u_xlat0.x + -0.319999993;
    u_xlat0.x = u_xlat0.x * 2.0 + -1.0;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat2 = u_xlat0.x + -0.5;
    u_xlat1.x = u_xlat0.x * _Diffuse_ST.x;
    u_xlatb0 = u_xlat2<0.0;
    if(u_xlatb0){discard;}
    u_xlat1.y = 0.0;
    u_xlat0.xy = u_xlat1.xy + _Diffuse_ST.zw;
    u_xlat10_0.xyz = texture2D(_Diffuse, u_xlat0.xy).xyz;
...
uniform 	vec4 _Diffuse_ST;
uniform 	vec4 _Dissolve_ST;
UNITY_LOCATION(0) uniform mediump sampler2D _Dissolve;
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xx * vec2(1.0, 0.0) + vs_TEXCOORD0.xy;
    u_xlat0.xy = u_xlat0.xy * _Dissolve_ST.xy + _Dissolve_ST.zw;
    u_xlat16_0.x = texture(_Dissolve, u_xlat0.xy).x;
    u_xlat0.x = vs_COLOR0.w * 0.720000029 + u_xlat16_0.x;
    u_xlat0.x = u_xlat0.x + -0.319999993;
    u_xlat0.x = u_xlat0.x * 2.0 + -1.0;
    ...
    u_xlat1.y = 0.0;
    u_xlat0.xy = u_xlat1.xy + _Diffuse_ST.zw;
    u_xlat16_0.xyz = texture(_Diffuse, u_xlat0.xy).xyz;
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xy * _Dissolve_ST.xy + _Dissolve_ST.zw;
    u_xlat10_0 = texture2D(_Dissolve, u_xlat0.xy).x;
    u_xlat0.x = vs_COLOR0.w * 0.720000029 + u_xlat10_0;
    u_xlat0.x = u_xlat0.x + -0.319999993;
    u_xlat0.x = u_xlat0.x * 2.0 + -1.0;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat0.xy = u_xlat0.xx * vec2(1.0, 0.0) + vs_TEXCOORD1.xy;
    u_xlat0.xy = u_xlat0.xy * _Dissolve_ST.xy + _Dissolve_ST.zw;
    u_xlat16_0 = texture(_Dissolve, u_xlat0.xy).x;
    u_xlat0.x = vs_COLOR0.w * 0.720000029 + u_xlat16_0;
    u_xlat0.x = u_xlat0.x + -0.319999993;
    u_xlat0.x = u_xlat0.x * 2.0 + -1.0;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.x = min(max(u_xlat0.x, 0.0), 1.0);
