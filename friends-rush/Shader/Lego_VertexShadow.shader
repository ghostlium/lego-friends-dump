...
void main()
{
    ...
    SV_Target0.w = u_xlat0 * _Opacity;
    SV_Target0.xyz = _ShadowColour.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat1.xyz = (-unity_FogColor.xyz) + _ShadowColour.xyz;
